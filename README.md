...
## Historical 2022 Material

`2022Cup/` is a preserved archive of the earlier World Cup project. It contains
simulation code, old website pages, data files, generated match-up images,
flags, templates, Processing visualizations, and media assets. It is excluded
from the current Ruff configuration and should be treated as historical
reference unless a task explicitly targets it.
